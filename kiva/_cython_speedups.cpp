 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_10 = PyObject_Length(__pyx_v_pts); if (unlikely(__pyx_t_10 == ((Py_ssize_t)-1))) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_uint8_t(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    ...
    __pyx_t_8 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_pts_view.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_8 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_pts_view.shape[0])) __pyx_t_8 = 0;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_pts_view.shape[1];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_8 = 1;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_pts_view.shape[1])) __pyx_t_8 = 1;
 ...
 */
    ...
    __pyx_t_8 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_poly_pts_view.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_8 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_poly_pts_view.shape[0])) __pyx_t_8 = 0;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_poly_pts_view.shape[1];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_8 = 1;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_poly_pts_view.shape[1])) __pyx_t_8 = 1;
    if (unlikely(__pyx_t_8 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_8);
 ...
 *                                             poly_pts_view.shape[0],
 */
    kiva::points_in_polygon_winding((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_pts_view.data + __pyx_t_12 * __pyx_v_pts_view.strides[0]) )) + __pyx_t_13)) )))), (__pyx_v_pts_view.shape[0]), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_poly_pts_view.data + __pyx_t_14 * __pyx_v_poly_pts_view.strides[0]) )) + __pyx_t_15)) )))), (__pyx_v_poly_pts_view.shape[0]), (&(*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5numpy_uint8_t *) __pyx_v_results.data) + __pyx_t_16)) )))), (__pyx_v_results.shape[0]));
 ...
 */
  /*else*/ {
    ...
    __pyx_t_8 = -1;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_pts_view.shape[0];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_8 = 0;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_pts_view.shape[0])) __pyx_t_8 = 0;
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_pts_view.shape[1];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_8 = 1;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_pts_view.shape[1])) __pyx_t_8 = 1;
    if (unlikely(__pyx_t_8 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_8);
 ...
 */
    ...
    __pyx_t_8 = -1;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_poly_pts_view.shape[0];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_8 = 0;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_poly_pts_view.shape[0])) __pyx_t_8 = 0;
    if (__pyx_t_20 < 0) {
      __pyx_t_20 += __pyx_v_poly_pts_view.shape[1];
      if (unlikely(__pyx_t_20 < 0)) __pyx_t_8 = 1;
    } else if (unlikely(__pyx_t_20 >= __pyx_v_poly_pts_view.shape[1])) __pyx_t_8 = 1;
    if (unlikely(__pyx_t_8 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_8);
 ...
 */
    ...
    } else if (unlikely(__pyx_t_21 >= __pyx_v_results.shape[0])) __pyx_t_8 = 0;
    if (unlikely(__pyx_t_8 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_8);
 ...
 *                                     poly_pts_view.shape[0],
 */
    kiva::points_in_polygon((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_pts_view.data + __pyx_t_17 * __pyx_v_pts_view.strides[0]) )) + __pyx_t_18)) )))), (__pyx_v_pts_view.shape[0]), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_poly_pts_view.data + __pyx_t_19 * __pyx_v_poly_pts_view.strides[0]) )) + __pyx_t_20)) )))), (__pyx_v_poly_pts_view.shape[0]), (&(*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5numpy_uint8_t *) __pyx_v_results.data) + __pyx_t_21)) )))), (__pyx_v_results.shape[0]));
  }
  __pyx_L9:;
 ...
 * 
 */
  __pyx_tuple__35 = PyTuple_Pack(6, __pyx_n_s_pts, __pyx_n_s_poly_pts, __pyx_n_s_use_winding, __pyx_n_s_pts_view, __pyx_n_s_poly_pts_view, __pyx_n_s_results); if (unlikely(!__pyx_tuple__35)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__35);
  __Pyx_GIVEREF(__pyx_tuple__35);
  __pyx_codeobj__36 = (PyObject*)__Pyx_PyCode_New(3, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__35, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_speedups_pyx, __pyx_n_s_points_in_polygon, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__36)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kiva._cython_speedups", 0, __pyx_lineno, __pyx_filename);
    }
